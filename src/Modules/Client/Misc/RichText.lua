...
richText.ColorShortcuts.Purple = Color3.new(0.721569, 0.439216, 1)
...
richText.ColorShortcuts.Grey = Color3.new(0.505882, 0.505882, 0.505882)
richText.ColorShortcuts.White = Color3.new(1, 1, 1)
richText.ColorShortcuts.PastelYellow = Color3.new(1, 0.898039, 0.313725)
richText.ColorShortcuts.NiceGreen = Color3.new(0.333333, 1, 0.498039)
